        ...
        <?php
          ...
          ?>
                ...
                <form align=center action="login.php" method="post">
    						...
    						<input class="btn btn-primary btn-block" id="sign-in" value="Sign In" type="submit">
              </form>
          <?php
              }
            ?>
...
<div class="row" >
  ...
  <div class="btn-group" role="group">
   ...
   <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
	...
	<div class="col-sm-10" >
	<img src="image/pork3_1.png"  alt="" style="display:block; margin:auto;" >
	</div>
	<div class="col-sm-1"></div>

	<div class="col-sm-1"></div>
  <div class="buwe-k col-sm-10" >
	  <h2 align="center"><strong>腹脇排</strong></h2><br>
		<h4 align="center">又稱為「腩排」，含胸骨、肋骨、肋軟骨、肋間肌肉(及部份腹脇瘦肉)。肉層比較厚，脂肪含量高，並帶有白色軟骨。<br><br>
		烹煮方式：<br>
		適合用紅燒、蒸煮、醬滷、燒烤與燉湯等烹調方法。<br><br>
