...
<div class="row" >
  ...
  <div class="btn-group" role="group">
   ...
   <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
	...
	<div class="col-sm-10" >
	<img src="image/pork1_1.png " alt="" style="display:block; margin:auto;" >
	</div>
	<div class="col-sm-1"></div>
  ...
  <div class="buwe-k col-sm-10" >
	  <h2 align="center"><strong>梅花肉</strong></h2><br>
		<h4 align="center">
			不像五花油脂多、里肌瘦，肥瘦各半且均勻分布的梅花肉肉質鮮嫩，因花紋貌似梅花點點而得其名，是豬肉中濃郁鮮美成分最多的代表性部位。<br>
			又稱胛心肉，位於上肩胛的肉，是最常使用的部位，油花多，有筋有肉，肉質嫩，用途廣泛。<br><br>
			烹煮方式：<br>
			梅花肉因其油花多，因此適合以燒烤的方式來烹調，另外也可做成火鍋肉片、叉燒肉等。<br><br>
