...
<div class="row" >
  ...
  <div class="btn-group" role="group">
   ...
   <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
	...
	<div class="col-sm-10" >
	<img src="image/pork4_1.png "  width="640" height="400" alt="" style="display:block; margin:auto;" >
	</div>
	<div class="col-sm-1"></div>

	<div class="col-sm-1"></div>
  <div class="buwe-k col-sm-10" >
	  <h2 align="center"><strong>豬腳</strong></h2><br>
		<h4 align="center">
		豬腳又叫豬蹄、豬手、元寶，分前後兩種，前腳肉多骨少，呈彎形，後腳肉少骨稍多，呈直形。<br><br>
		烹煮方式：<br>
		適合滷豬腳、紅燒豬腳、花生豬腳湯等烹調方法<br><br>
