...
<div class="row" >
  ...
  <div class="btn-group" role="group">
   ...
   <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
	...
	<div class="col-sm-10" >
	<img src="image/pork4_3.png " alt="" style="display:block; margin:auto;" >
	</div>
	<div class="col-sm-1"></div>

	<div class="col-sm-1"></div>
  <div class="buwe-k col-sm-10" >
	  <h2 align="center"><strong>腱子肉</strong></h2><br>
		<h4 align="center">
		又稱「老鼠肉」，位於豬的前腿和後腿內，每隻豬只能取出4塊豬腱肉，外有肉膜包裹著，内藏筋，紋路規則，肉質結實。<br><br>
			烹煮方式：<br>
			適合燉滷、煮湯，經過燉煮後稍帶肉質纖維，頗有嚼勁。<br><br>
