...
<body><header class="business-header">
...
<div class="row" >
  ...
  <div class="btn-group" role="group">
   ...
   <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
	...
	<div class="col-sm-10" >
	<img src="image/pork4_2.png " alt="" style="display:block; margin:auto;" >
	</div>
	<div class="col-sm-1"></div>

	<div class="col-sm-1"></div>
  <div class="buwe-k col-sm-10" >
	  <h2 align="center"><strong>後腿肉</strong></h2><br>
		<h4 align="center">去皮， 去骨， 含後腿內、外腱肉。位於後腳蹄膀的上方，肉質細嫩柔軟、脂肪較少的部位，分為「內腿肉」與「腿心」兩個部分，是瘦肉的代表性部位。<br><br>
			烹煮方式：<br>
			可用整塊肉做烤豬肉或叉燒肉等，適合品嚐豬腿肉原有美味的料理。<br><br>
