...
<div class="row" >
  ...
  <div class="btn-group" role="group">
   ...
   <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
	...
	<div class="col-sm-10" >
	<img src="image/pork1_6.png " alt="" style="display:block; margin:auto;" >
	</div>
	<div class="col-sm-1"></div>

	<div class="col-sm-1"></div>
  <div class="buwe-k col-sm-10" >
	  <h2 align="center"><strong>胛心排</strong></h2><br>
		<h4 align="center">
		不含胸骨，含肋骨、肋間肌肉、頸椎及胸椎。(分左右半邊)附著胛心肉的骨頭，骨頭寬扁、粗大。<br><br>
		烹煮方式：<br>
		適宜紅燒、燉湯及烤的方法烹調，在歐美國家中是烤豬肋排的主要食材。<br><br>
