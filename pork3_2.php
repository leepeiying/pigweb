...
<div class="row" >
  ...
  <div class="btn-group" role="group">
   ...
   <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
	...
	<div class="col-sm-10" >
	<img src="image/pork3_2.png" alt="" style="display:block; margin:auto;" >
	</div>
	<div class="col-sm-1"></div>

	<div class="col-sm-1"></div>
  <div class="buwe-k col-sm-10" >
	  <h2 align="center"><strong>腹脇肉</strong></h2><br>
		<h4 align="center">
		又稱為「五花肉」、「三層肉」，取自肚腩的部位，是由脂肪和瘦肉均衡夾層組成的部位，因此油脂夠、口感Q嫩。<br><br>
		烹煮方式：<br>
		適合滷煮、切薄片與切絲等烹調方法，薄片可做培根、豬肉丼、燒烤、白肉火鍋；厚片可做叉燒肉、蒜泥白肉、梅干扣肉、東坡肉、焢肉飯。<br><br>
