...
<div class="row" >
  ...
  <div class="btn-group" role="group">
   ...
   <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
	...
	<div class="col-sm-10" >
	<img src="image/pork2_1.png "  alt="" style="display:block; margin:auto;" >
	</div>
	<div class="col-sm-1"></div>

	<div class="col-sm-1"></div>
  	<div class="buwe-k col-sm-10" >
	  <h2 align="center"><strong>大里肌</strong></h2><br>
		<h4 align="center">
		位於豬隻背脊中央的部位，大里肌肉比起小里肌肉更有咬勁，並且帶有適當的油花。<br><br>
		烹煮方式：<br>
		適合煎、炸、炒等烹調方法。<br><br>
...
<footer>
  <div class="card">
    ...
    <!--copy navbar script-->
<script src="file:///C|/Users/rose1/Desktop/js/popper.min.js"></script>
<script>
