...
<div class="row" >
  ...
  <div class="col-sm-12" align="center">
	  <a href="pork2_1.php"><img src="image/pork2_1.png" class="img-fluid" width="230" height="230" alt="大里肌" title="大里肌"></a>
	  <a href="pork2_2.php"><img src="image/pork2_2.png" class="img-fluid" width="230" height="230" alt="小里肌" title="小里肌"></a>
	  <a href="pork2_3.php"><img src="image/pork2_3.png" class="img-fluid" width="230" height="230" alt="大排" title="大排"></a>
	  <a href="pork2_4.php"><img src="image/pork2_4.png" class="img-fluid" width="230" height="230" alt="小排" title="小排"></a>
  </div>

<div class="col-sm-1"></div>
	<div class="buwe-k col-sm-10" >
	  <h2 align="center"><strong>背脊部</strong></h2><br>
		<h3 align="center">
		在此本網站採用的是四部位切分方法:<br>
		里肌肉的最大不同就是附帶骨頭，炸起來特別香甜，為豬體最大、最長的肌肉，肉質鮮嫩，少許脂肪。<br><br>
		分切方法：<br>
		由腸肋肌前端和被中線呈平行切離開為背脊與腹脇。<br>
		</h3>
  ...
  <?php
    ...
    $sql = "select * from recipe where part='2' order by CTR DESC";
