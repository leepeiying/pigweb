...
<div class="row" >
  ...
  <div class="btn-group" role="group">
   ...
   <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
	...
	<div class="col-sm-10" >
	<img src="image/pork1_5.png " alt="" style="display:block; margin:auto;" >
	</div>
	<div class="col-sm-1"></div>

	<div class="col-sm-1"></div>
  <div class="buwe-k col-sm-10" >
	  <h2 align="center"><strong>豬頸骨</strong></h2><br>
		<h4 align="center">
		部份位於「排骨」的前部，老一輩人稱為「排骨頭」。屬於肉多的排骨，因肉紋相似梅花，因此又稱「梅花排骨」。<br><br>
		烹煮方式：<br>
		適合長時間烹煮的料理，常用於熬湯。<br><br>
