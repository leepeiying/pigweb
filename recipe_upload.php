...
?>
    ...
    <!------------------------------輸入資訊欄位--------------------------------->
    	  <div class="card-header" align="center">上傳食譜</div>

        <form align=center action="recipe_uploadaction.php" method="post" enctype="multipart/form-data">

          <br>
          　食譜名稱：　<input type='text' name="recipename" maxlength="20" placeholder="限20字數內" required><br><br>
            　　　　　　圖片：　　　<input type='file' name="photo" accept="image/*" required><br><br><br>
        　　部位：  <input type="radio" name="part" value="1" checked>肩胛部
          ...
          食材：<br><br>                <textarea name="ingredient" style="width:500px;height:300px;" maxlength="300" minlength="10" placeholder="字數限10至300個" required></textarea><br><br><br>
          步驟：<br><br>                <textarea name="procedue" style="width:500px;height:300px;" maxlength="500" minlength="10" placeholder="字數限10至500個" required></textarea><br><br><br>

           <input type="reset" id="submit" onclick="formReset();" value="清除"><input type="submit" id="submit"><br><br>
