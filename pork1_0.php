...
<div class="row" >
  ...
  <div class="col-sm-12" align="center">
	  <a href="pork1_1.php"><img src="image/pork1_1.png" class="img-fluid" width="230" height="230" alt="梅花肉" title="梅花肉"></a>
	  <a href="pork1_2.php"><img src="image/pork1_2.png" class="img-fluid" width="230" height="230" alt="豬頸肉" title="豬頸肉"></a>
	  <a href="pork1_3.php"><img src="image/pork1_3.png" class="img-fluid" width="230" height="230" alt="頰肉" title="頰肉"></a>
	  <a href="pork1_4.php"><img src="image/pork1_4.png" class="img-fluid" width="230" height="230" alt="龍骨" title="龍骨"></a>
	  <a href="pork1_5.php"><img src="image/pork1_5.png" class="img-fluid" width="230" height="230" alt="豬頸骨" title="豬頸骨"></a>
	  <a href="pork1_6.php"><img src="image/pork1_6.png" class="img-fluid" width="230" height="230" alt="胛心排" title="胛心排"></a>
  </div>

<div class="col-sm-1"></div>
	<div class="buwe-k col-sm-10" >
	  <h2 align="center"><strong>肩胛部</strong></h2><br>
		<h3 align="center">
		在此本網站採用的是四部位切分方法:<br>
		肩胛部位於背脊前方到肩胛骨處。肩胛肉細部分切為梅花肉與前腿肉，常見的梅花肉則是指位於肩胛肉上方(及肩骨上的肉)。<br><br>
		分切方法：<br>
		由第2與6肋骨間擇一處切割，並從背中線沿肋骨中間切割。<br>
		</h3>
