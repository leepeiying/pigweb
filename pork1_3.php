...
<div class="row" >
  ...
  <div class="btn-group" role="group">
   ...
   <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
	...
	<div class="col-sm-10" >
	<img src="image/pork1_3.png " alt="" style="display:block; margin:auto;" >
	</div>
	<div class="col-sm-1"></div>
  ...
  <div class="buwe-k col-sm-10" >
	  <h2 align="center"><strong>頰肉</strong></h2><br>
		<h4 align="center">
		是舌旁臉頰肉，稱為「嘴邊肉」，又因為肉紋像菊花，又稱「菊花肉」，俗稱的松阪肉或霜降頸肉也是在此部位。<br>
		油脂不多，肉質軟中帶嚼勁。<br><br>
		烹煮方式：<br>
		適合汆燙切片、煮湯或燒烤的烹調方法，麵攤常見的小吃配菜之一。<br><br>
