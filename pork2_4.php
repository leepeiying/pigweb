...
<div class="row" >
  ...
  <div class="btn-group" role="group">
   ...
   <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
	...
	<div class="col-sm-10" >
	<img src="image/pork2_4.png " alt="" style="display:block; margin:auto;" >
	</div>
	<div class="col-sm-1"></div>

	<div class="col-sm-1"></div>
  <div class="buwe-k col-sm-10" >
	  <h2 align="center"><strong>小排</strong></h2><br>
		<h4 align="center">
		小排位於背脊旁的肋骨，呈現出連骨帶肉一整塊的塊狀。而肋間的肉，肥瘦均等。<br>
		里肌小排肉質為全瘦肉，適合油炸，若希望肉質軟嫩，則不建議熬煮；五花小排又稱「子排」、「腩排」，五花小排上面的肉就是五花肉。<br>
		小排部位都有許多軟骨，對於需要自然補鈣的人很有幫助。<br><br>
		烹煮方式：<br>
		適合以紅燒、燉湯、蒸、油炸與燒烤等烹調方法。常見料理有佛跳牆、排骨酥、糖醋排骨。<br><br>
