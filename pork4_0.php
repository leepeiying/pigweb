...
<div class="row" >
  ...
  <div class="col-sm-12" align="center">
	  <a href="pork4_1.php"><img src="image/pork4_1.png" class="img-fluid" width="230" height="230" alt="豬腳" title="豬腳"></a>
	  <a href="pork4_2.php"><img src="image/pork4_2.png" class="img-fluid" width="230" height="230" alt="後腿肉" title="後腿肉"></a>
	  <a href="pork4_3.php"><img src="image/pork4_3.png" class="img-fluid" width="230" height="230" alt="腱子肉" title="腱子肉"></a>
  </div>

<div class="col-sm-1"></div>
	<div class="buwe-k col-sm-10" >
	  <h2 align="center"><strong>後腿部</strong></h2><br>
		<h3 align="center">
		在此本網站採用的是四部位切分方法:<br>
		位於後腳蹄膀的上方，肉質細嫩柔軟、脂肪較少的部位，分為「內腿肉」與「腿心」兩個部分，是瘦肉的代表性部位。<br><br>
		分切方法：<br>
		由恥骨前下方將小里肌頭部切離後腿，然後沿著腿心前緣切進腹直肌，再於最後第1 與第2腰椎間和背中線呈直角切斷。<br>
		</h3>
    ...
    <?php
      ...
      $sql = "select * from recipe where part='4' order by CTR DESC";
