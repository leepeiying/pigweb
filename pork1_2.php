...
<div class="row" >
  ...
  <div class="btn-group" role="group">
   ...
   <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
	...
	<div class="col-sm-10" >
	<img src="image/pork1_2.png " alt="" style="display:block; margin:auto;" >
	</div>
	<div class="col-sm-1"></div>
  ...
  <div class="buwe-k col-sm-10" >
	  <h2 align="center"><strong>豬頸肉</strong></h2><br>
		<h4 align="center">
		位於豬脖子兩側，俗稱「松阪豬肉」，正式名稱應該叫做「僧帽肌」。肉販又稱為「離緣肉（台語）」或「翅仔肉（台語）」，又因為一隻豬約只能取六兩，又有「黃金六兩肉」之稱，「雪花肉」與「霜降肉」也是稱指此部位。油花分布均勻，而超市販賣的名稱也會因其油脂分布均勻的關係，稱為雪花里肌肉，豬頸肉肉質口感脆彈，比起其他部位來得鮮嫩許多，是所有豬肉口感中最佳的。<br><br>
		烹煮方式：<br>
		適合快速烹調，掌握料理的速度與切成薄片，不適合用燜等久煮方式烹調。<br><br>
