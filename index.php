...
<!--------------------------------------上方點選欄位----------------------------------------------------------------------------->
	...
	<div class="col-md-6">
      ...
      <!-- /.row -->
	<div class="card-header" align="center">本週熱門食譜</div>
	<div class="row">
			...
			if($count==1)
        	{
				 ...
				 ?>
				    <div class="col-sm-5 my-4">
      				<div class="card">
      				<div class="card-1">
      				<img class="card-img-top" src="<?php echo "upload/$recipe_ID.$image"; ?>" alt="">
                 		<div class="card-body">
            ...
            <div class="col-sm-5 my-4">
                ...
                <img class="card-img-top" src="image/1.png" alt="">
                      <div class="card-body">
                        ...
                        <p class="card-text">暫無資料</p>
                      </div>

                <div class="card-footer" align="center">
                    <a href="recipe_in.php" class="btn btn-info">查看更多</a>
    ...
    ?>
  	...
  	<div class="col-xs-12">
         	<div class="text-right">
  			<a href="recipe.php" class="btn btn-info btn-lg">
  				<span class="glyphicon glyphicon-menu-right btn-right"></span> 更多食譜 » </a>
         	</div>
      </div>
