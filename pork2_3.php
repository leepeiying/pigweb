...
<div class="row" >
  ...
  <div class="btn-group" role="group">
   ...
   <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
	...
	<div class="col-sm-10" >
	<img src="image/pork2_3.png " alt="" style="display:block; margin:auto;" >
	</div>
	<div class="col-sm-1"></div>

	<div class="col-sm-1"></div>
  <div class="buwe-k col-sm-10" >
	  <h2 align="center"><strong>大排</strong></h2><br>
		<h4 align="center">
		大排為帶骨里肌肉的俗稱。炸起來特別香甜，為豬體最大、最長的肌肉，肉質鮮嫩，少許脂肪。<br><br>
		烹煮方式：<br>
		適合滷、烤的烹調方法，常被用來製作中式排骨便當中的排骨。<br><br>
