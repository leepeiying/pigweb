...
<div class="row" >
  ...
  <div class="col-sm-12" align="center">
	  <a href="pork3_1.php"><img src="image/pork3_1.png" class="img-fluid" width="230" height="230" alt="腹脇排" title="腹脇排"></a>
	  <a href="pork3_2.php"><img src="image/pork3_2.png" class="img-fluid" width="230" height="230" alt="腹脇肉" title="腹脇肉"></a>
  </div>

<div class="col-sm-1"></div>

	<div class="buwe-k col-sm-10" >
	  <h2 align="center"><strong>腹脇部</strong></h2><br>
		<h3 align="center">
		在此本網站採用的是四部位切分方法:<br>
    ...
    <?php
      ...
      $sql = "select * from recipe where part='3' order by CTR DESC";
