  ...
  <div class="btn-group" role="group">
   ...
   <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
	...
	<div class="col-sm-10" align="center">
		<div class="pig">
			<img class="card-img" src="image/pig.png" alt="" >

		<div class="pig-main">
			<a href="pork1_0.php"><img class="a col-sm-3 " src="image/pig-1.png" alt=""></a>
			<a href="pork2_0.php"><img class="b col-sm-3 " src="image/pig-2.png" alt=""></a>
			<a href="pork3_0.php"><img class="c col-sm-3 " src="image/pig-3.png" alt=""></a>
			<a href="pork4_0.php"><img class="d col-sm-3 " src="image/pig-4.png" alt=""></a>
		</div>
		</div>
	</div>
	...
	<div class="buwe-k col-sm-10" >
		<h2 align="center"><strong>部位小知識</strong></h2><br>
		<h3 align="center">你知道你吃的豬排、東坡肉、火腿、培根和梅花豬肉這些，是在豬的哪個部位嗎？<br></h3>
		<h4>豬肉在臺灣為肉食的主要來源，民國46年每人每年平均豬肉消費量為12公斤；
		至今，消費量已增加為每人每年40公斤，佔所有肉類消費的50%。目前台灣豬肉的運銷過程如下：<br>
		屠前檢查→電動屠宰→屠後檢查→預冷→分切分級包裝→運輸→販賣→消費者<br><br>
		而不同國家分切方式有些許不同：</h4>
		<ol>
			<h4><li><strong>四部位分切：</strong>在臺灣、紐西蘭、澳洲、英國、法國、比利時等國家採用四部位分切法，將肉豬屠體分切為肩腿部、背脊部、腹部及後腿部。</li></h4>

			<h4><li><strong>五部位分切：</strong>在美國、日本、丹麥等國家採用五部位分切，將肉豬屠體分切為肩背部、前腿部、背脊部、腹部及後腿部。</li></h4>

			<h4><li><strong>六部位分切：</strong>在捷克、波蘭等家採用六部位分切，將肉豬屠體分切為背脊部、前腿部、前膊部、腹部、後腿部及下腿部。</li></h4>
		</ol>
	</div>
	<div class="col-sm-1"></div>

	<div class="col-sm-12" align="center"><h3><strong>熱門食譜</strong></h3></div>
...
<?php
  ...
  while ($count<4)
  {
    ...
    <div class="col-sm-6 col-md-3" >
        <div class="card" >
          <div class="card-7">
          <img class="card-img-top" src="image/1.png" alt="" id="knowledge-t">
            <div class="card-body">
          ...
          <div class="card-footer" align="center">
            <a href="#" class="btn btn-info">查看更多</a>
              <input type=button id='btn' value='♥ 收藏'>
          </div>
          </div>
        </div>
    </div>
