...
<div class="row" >
  ...
  <div class="btn-group" role="group">
   ...
   <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
	...
	<div class="col-sm-10" >
	<img src="image/pork2_2.png "  alt="" style="display:block; margin:auto;" >
	</div>
	<div class="col-sm-1"></div>

	<div class="col-sm-1"></div>
  <div class="buwe-k col-sm-10" >
	  <h2 align="center"><strong>小里肌</strong></h2><br>
		<h4 align="center">
		又稱「腰內肉」，位於豬隻腰脊，是豬隻身上運動最少的部位，脂肪含量低、沒有骨頭也沒有筋，肉味較淡，口感和肉質最細，及豬菲力。<br><br>
		烹煮方式：<br>
		適合快速烹調如煎、炸、炒、烤等方法，口感才能鮮嫩、多汁。常醃過後用來製作日式炸豬排或者是西餐中的煎豬排。<br><br>
