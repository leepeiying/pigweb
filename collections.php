...
?>
        ...
        <script type='text/javascript'>window.location.href='recipe.php'</script>
<?php
}
else
{
?>
    ...
    <!--------------------------------------上方點選欄位----------------------------------------------------------------------------->
    	...
    	<div class="col-md-6">
          ...
          <!-- /.row -->
    <div class="card-header" align="center">我的收藏</div>
      ...
      <?php
        ...
        if (!isset($_GET["page"])){ //假如$_GET["page"]未設置
            $page=1; //則在此設定起始頁數
              ...
              {
                  $collect_rid=$row["recipe"];
                  $sql = "select * from recipe where recipe_ID='$collect_rid'";
