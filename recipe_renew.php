...
if(!isset($_SESSION["username"]))
{
  ...
  <?php
    ...
    else
    {
        ...
        $ingredient2=strip_tags($ingredient);
        $procedue2=strip_tags($procedue);
    }
  }
?>
<html lang="en">
...
<!------------------------------輸入資訊欄位--------------------------------->
	  <div class="card-header" align="center">修改食譜</div>

    <form align=center action="recipe_renew2.php" method="post" enctype="multipart/form-data">
      <br>
      　食譜名稱：　<input type='text' name="recipe_name" maxlength="20" placeholder="限20字數內" required value=<?php echo"'$recipename'>　"; ?><br><br>
    　　部位：  <input type="radio" name="part" value="1">肩胛部
        <input type="radio" name="part" value="2">背脊部
        <input type="radio" name="part" value="3">腹脇部
        <input type="radio" name="part" value="4">後腿部<br><br><br>
      食材：<br><br>   <textarea name="ingredient" style="width:500px;height:300px;" maxlength="300" minlength="10" placeholder="字數限10至300個" required><?php echo"$ingredient2"; ?></textarea><br><br><br>
      步驟：<br><br>   <textarea name="procedue" style="width:500px;height:300px;" maxlength="500" minlength="10" placeholder="字數限10至500個" required><?php echo"$procedue2"; ?></textarea><br><br><br>

       <input type="reset" id="submit" onclick="formReset();" value="清除"><input type="submit" id="submit" value="確認修改"><br><br>
